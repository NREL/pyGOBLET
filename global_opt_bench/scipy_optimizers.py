...
profiles_time = bt.compute_performance_profiles(ratios_time, tau_grid=np.linspace(1, 10, 100))
profiles_fxn_evals = bt.compute_performance_profiles(ratios_fxn_evals, tau_grid=np.linspace(1, 10, 100))
