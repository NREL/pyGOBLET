...
The standard problems module provides a collection of widely used benchmark functions for optimization algorithms, primarily from the `Virtual Library of Simulation Experiments <https://www.sfu.ca/~ssurjano/optimization.html>`.
...
.. automodule:: pygold.problems.floris_problems
    :members:
    :undoc-members:
